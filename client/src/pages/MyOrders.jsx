...
import { AppContext } from '../context/AppContext';import toast from 'react-hot-toast';
;
            ...
            <div key={index} className='border border-gray-300 rounded-lg mb-10 p-4 py-5 max-w-4xl '>
                ...
                {order.items.map((item, index) => (
                    <div key={index} 
                        ...
                        ${order.items.length !== index + 1 && "border-b"}`}> {/*This line is for seperating different products in a single order*/ }
